...
function init(){
  ...
  var nzms1999 = new OpenLayers.Layer.TMS("NZMS260 1999", "https://object-storage.nz-por-1.catalystcloud.io/v1/AUTH_b1d1ad52024f4f1b909bfea0e41fbff8/mapspast/2193/nzms260-1999/",
  {
      serviceVersion: '.',
      layername: '.',
      alpha: true,
  ...
  if (layerid=='selected sheet') {
    ...
    map.addLayers([ nztm2019, nztm2009, nzms1999, nzms1989, nzms1979, nzms1969, nzms1959, nzms1949, nzms1939, nzms1929, nzms1919, nzms1909, nzms1899, vectorLayer]);
  }
